...
export default function Hero() {
    return (
        <section id="home" className="lg:mt-29 md:mt-24 sm:mt-14 mt-10 grid md:grid-cols-2 grid-cols-1 justify-center md:pt-16 pt-14 md:pb-24 pb-18 md:px-13 px-5 md:gap-6 gap-5.5">
