        ...
        >
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-10 relative -mx-2 sm:mx-0 h-full">
                    ...
                    <div className="relative overflow-hidden rounded-xl h-full border border-background/10 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-[0_0_40px_rgba(109,40,217,0.18)] cursor-pointer">
                        <Image
