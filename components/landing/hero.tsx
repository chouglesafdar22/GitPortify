...
export default function Hero() {
    return (
        <section id="home" className="lg:mt-29 md:mt-24 sm:mt-14 mt-10 grid md:grid-cols-2 grid-cols-1 justify-center pt-18 md:pb-26 pb-22 md:px-13 px-5 md:gap-6 gap-5.5">
