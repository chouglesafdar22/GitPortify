...
export default function Faq() {
    ...
    return (
        <section id="faq" className="lg:mt-7 md:mt-6 sm:mt-5 mt-4 flex flex-col justify-center items-center md:px-14 px-1 md:py-10 py-5 md:gap-3.5 gap-2 md:pb-1.5 pb-0.5">
