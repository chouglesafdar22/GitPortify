...
export default function Faq() {
    ...
    return (
        <section id="faq" className="lg:mt-7 md:mt-6 sm:mt-5 mt-4 flex flex-col justify-center items-center md:px-14 px-7 md:py-10 py-5 md:gap-3.5 gap-2">
            ...
            <div className="flex flex-col justify-center items-center md:px-24 px-10 md:py-16 py-6 md:gap-8 gap-4">
                {faqs.map((faq, index) => (
                    <FaqCard
                        key={index}
                        que={faq.que}
