...
export default function Template() {
    return (
        <section id="templates" className="lg:mt-7 md:mt-6 sm:mt-5 mt-4 flex flex-col justify-center items-center md:px-14 px-5 md:py-10 py-5 md:gap-7 gap-5">
            ...
            <div className="relative w-full">
                ...
                {/* Scroll Container */}
                <div
                    className="flex gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-3 px-1 cursor-grab active:cursor-grabbing"
                >
