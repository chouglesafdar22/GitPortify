...
export default function Feature() {
    return (
        <section id="features" className="lg:mt-7 md:mt-6 sm:mt-5 mt-4 flex flex-col justify-center items-center md:px-14 px-5 md:py-10 py-5 md:gap-7 gap-5 md:pb-22 pb-18">
