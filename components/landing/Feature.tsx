...
export default function Feature() {
    return (
        <section id="features" className="lg:mt-7 md:mt-6 sm:mt-5 mt-4 flex flex-col justify-center items-center md:px-14 px-5 md:py-10 py-5 gap-10 pb-30">
            <h2 className="text-foreground xl:text-3xl md:text-2xl text-xl md:text-center text-left fira-sans-semibold">Features</h2>
