    ...
    return (
        <>
            ...
            <aside className="w-screen lg:w-80 sm:p-6 p-4 border-t lg:border-t-0 space-y-6">
                <h2 className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold mb-4">
                    Edit Profile
                </h2>

                {status === "dirty" && (
                    <p className="text-xs text-red-500">● Unsaved changes</p>
                )}
                {status === "saved" && (
                ...
                <div className="space-y-2 gap-1.5">
                    ...
                    <select
                        ...
                        className="w-full border rounded-md cursor-pointer px-3 py-2 text-sm bg-background"
                    >
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="cursor-pointer text-gray-500 text-sm border p-1.5 rounded-md"
                    />
                </div>
                ...
                {/* Username */}
                <div className="space-y-2">
                    <Label>Username (Portfolio URL)</Label>
                    <input
                        value={username}
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        rows={10}
                        className="max-h-25 w-full no-scrollbar"
                    />
                </div>
                ...
                <div className="space-y-3 pt-6 border-t">
                    ...
                    <Button
                        ...
                        className="w-full text-sm border rounded-md py-2 hover:bg-muted cursor-pointer"
                    >
                        + Add Project
                    </Button>
                    <div className="space-y-2">
                            ...
                            return (
                                <div key={project.id} className="border rounded-md">
                                    <button
                                        ...
                                        className="w-full cursor-pointer flex items-center justify-between px-3 py-2 text-sm hover:bg-muted"
                                    >
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex flex-wrap gap-1">
                                                    {project.tech.map((tech: string) => (
                                                        <span
                                                            key={tech}
                                                            className="text-xs px-2 py-1 rounded-md bg-muted flex items-center gap-1"
                                                        >
                                                            {tech}
                                                            <button
