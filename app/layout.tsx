...
export const metadata: Metadata = {
  title: "GitPortify - GitHub Powered Developer Portfolio Builder Platform",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth">
      <head>
        <meta name="google-site-verification" content="CmKds10cZMZYH-iisKQPsLzG9KgAGEq8aQxA0ru8q1I" />
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} bg-background text-foreground antialiased scroll-smooth`}
      >
        <Providers>
          <ThemeProvider>
            <TooltipProvider>
