                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-4 space-y-2">
                                    <h2 className="fira-sans-medium text-foreground">
                                        {template.name}
                                    </h2>
                                    <p className="text-xs fira-sans-regular text-muted-foreground">
                                ...
                                <button
                                    ...
                                    className={`w-full mt-2 text-sm px-3 py-2 rounded-md border transition-all duration-200 active:scale-95 cursor-pointer ${isSelceted
                                        ? "bg-violet-600 text-white border-violet-600 fira-sans-medium"
                                        : "hover:bg-muted hover:scale-[1.02] fira-sans-regular"
                                        }`}
                                >
